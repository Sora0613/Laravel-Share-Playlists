...
')
     ...
     */ 
        ...
        {
                        /** @var \App\Http\Components\MusicService $instance */
        ...
        {
                        return \App\Http\Components\MusicService::searchFromApple($keyword);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function GenerateSpotifyAuthUrl($state)
        {
                        /** @var \App\Http\Components\MusicService $instance */
                        return $instance->GenerateSpotifyAuthUrl($state);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getPlaylistId($playlist_url)
        {
                        /** @var \App\Http\Components\MusicService $instance */
                        return $instance->getPlaylistId($playlist_url);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \App\Http\Components\MusicService $instance */
                        return $instance->refreshAccessToken($refreshToken);
        }
...
namespace  { 
            ...
            class MusicService extends \App\Facades\MusicService {}
