 ...
 *
 * @property int $id
 * @property string $name ユーザーID
 * @property string $email
 * @property \Illuminate\Support\Carbon|null $email_verified_at
 * @property mixed $password
 * @property string|null $spotify_access_token
 * @property string|null $spotify_refresh_token
 * @property string|null $spotify_expires_at
 * @property int $spotify_login Spotifyにログインしているか
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|User whereSpotifyExpiresAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|User whereSpotifyLogin($value)
